...
#ifndef __MK4CURSOR_TYPE_H__
#define __MK4CURSOR_TYPE_H__

#include <pthread.h>

// Another nice example of include recursion
...
typedef struct {
  ...
  // The condition is part of the 'mk4cursor',
  // but the mutex protects a variable so it is part of the 'mk4array'
  pthread_cond_t  cond;

  unsigned long long int last_got_ts;
  int rb_overflow;
} mk4cursor;
