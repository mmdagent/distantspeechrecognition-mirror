...
/****************************************/
// Those sub parts (functions detailled in sub codes and other details)
// are all the things we do not want the user to meddle with,
// therefore we do not list them in the public profile of the library
// (ie 'mk4lib.h')
#ifndef _MK3LIB_INT_H_
#define _MK3LIB_INT_H_

#include <pthread.h>

#include "driver/mk4_common.h"
#include "driver/mk4error.h"
#include "driver/mk4msg.h"
#include "driver/mk4cursor.h"
