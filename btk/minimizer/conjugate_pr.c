...
conjugate_lsv_state_t;

static int
conjugate_lsv_alloc (void *vstate, size_t n)
{
  conjugate_lsv_state_t *state = (conjugate_lsv_state_t *) vstate;
...
static int
conjugate_lsv_set (void *vstate, gsl_multimin_function_fdf * fdf,
...
static void
conjugate_lsv_free (void *vstate)
{
  conjugate_lsv_state_t *state = (conjugate_lsv_state_t *) vstate;
...
static int
conjugate_lsv_restart (void *vstate)
{
  conjugate_lsv_state_t *state = (conjugate_lsv_state_t *) vstate;
...
static int
conjugate_lsv_iterate (void *vstate, gsl_multimin_function_fdf * fdf,
...
static const gsl_multimin_fdfminimizer_type conjugate_lsv_type = {
  "conjugate_pr",               /* name */
  sizeof (conjugate_lsv_state_t),
  &conjugate_lsv_alloc,
  &conjugate_lsv_set,
  &conjugate_lsv_iterate,
  &conjugate_lsv_restart,
  &conjugate_lsv_free
};

const gsl_multimin_fdfminimizer_type
  * gsl_multimin_fdfminimizer_conjugate_pr = &conjugate_lsv_type;
