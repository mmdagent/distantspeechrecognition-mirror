...
{
  printf("Creating 'PCA' dimN = %d\n", _dimN);  fflush(stdout);
}

PCA::~PCA()
{
  printf("Freeing 'PCA' dimN = %d\n", _dimN);  fflush(stdout);
  gsl_vector_free(_work);
}

void PCA::pca_svd(gsl_matrix* input, gsl_matrix* basis, gsl_vector* eigenVal, gsl_vector* whiten)
{
  printf("Performing principal component analysis based on singular value decomposition.\n");
...
{
  printf("Performing principal component analysis based on eigen value decomposition.\n");
...
{
  printf("Creating 'FastICA' dimN = %d\n", _dimN);  fflush(stdout);
}

FastICA::~FastICA()
{
  printf("Freeing 'FastICA' dimN = %d\n", _dimN);  fflush(stdout);
