				 ...
				 const gsl_vector_complex* c_m)
{
  ...
  choleskyBackSubComplex(A11, c_m, gH_m, /* conjugate = */ true);
  ...
  if (delta2_m < 0.0)
    throw jarithmetic_error("rankOneUpdateCholeskyFactor: delta2_m (%g) < 0.0",
			    delta2_m);
...
void propagateCovarSquareRootStep1(gsl_matrix* A12, gsl_matrix* A22)
{
...
static void propagateCovarSquareRootAll(gsl_matrix* A11, gsl_matrix* A12,
			      ...
			      gsl_matrix* A22, bool flag)
{
  ...
  if (flag) {
    propagateCovarSquareRootStep1(A12, A22);
    propagateCovarSquareRootStep2a(A11, A12, A21, A22);
    propagateCovarSquareRootStep2b(A22);
  } else {
    propagateCovarSquareRootAll(A11, A12, A21, A22);
...
void propagateCovarSquareRootReal(gsl_matrix* A11,
				  ...
				  gsl_matrix* A22, bool flag)
{
  propagateCovarSquareRoot(A11, A12, A21, A22, flag);
}
...
// Step 1: rotate rows of 'A12' into last column
void propagateInfoSquareRootStep1(gsl_matrix_complex* A12,
...
// Step 2: rotate last column into leading diagonal
void propagateInfoSquareRootStep2(gsl_matrix_complex* sqrt_Pm_inv,
				  gsl_matrix_complex* A12,
...
void propagateInfoSquareRootInOneStep(gsl_matrix_complex* sqrt_Pm_inv,
				      gsl_matrix_complex* A12,
				      gsl_vector_complex* a_21,
				      gsl_vector_complex* a_22)
{
			     ...
			     gsl_vector_complex* a_22, bool rankOneA12)
{
  ...
  // perform update
  if (rankOneA12) {
    propagateInfoSquareRootStep1(A12, a_22);
    propagateInfoSquareRootStep2(sqrt_Pm_inv, A12, a_21, a_22);
  } else {
    propagateInfoSquareRootInOneStep(sqrt_Pm_inv, A12, a_21, a_22);
  }
}
				 ...
				 gsl_complex a_22)
{
  ...
  // perform update
  propagateInfoSquareRootStep2_RLS(sqrt_Pm_inv, a_12, a_21, a_22);
}
...
//     Kailath [3].
//
//  3. The routine 'rankOneUpdateCholeskyFactor' is based on a
